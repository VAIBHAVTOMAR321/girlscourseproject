...
const AddGovtSchemes = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.scheme_category_id) {
    ...
    try {
      ...
      data.append('scheme_category_id', formData.scheme_category_id)
      data.append('title', formData.title)
      data.append('title_hindi', formData.title_hindi)
      data.append('description', formData.description)
      data.append('description_hindi', formData.description_hindi)
      data.append('sub_mod', JSON.stringify(formData.sub_mod))
      data.append('sub_mod_hindi', JSON.stringify(formData.sub_mod_hindi))
      data.append('web_link', formData.web_link)

      if (formData.gov_scheme_id) {
        data.append('gov_scheme_id', formData.gov_scheme_id)
        await axios.put('https://brjobsedu.com/girls_course/girls_course_backend/api/scheme/', data, {
          ...config,
        ...
        await axios.post('https://brjobsedu.com/girls_course/girls_course_backend/api/scheme/', data, {
          ...config,
          headers: { ...config.headers, 'Content-Type': 'multipart/form-data' }
        })
